<template>
  <div class="q-mb-xl q-pb-md">
    ...
    @mousedown.native.prevent
      ...
      <template v-slot:top="props">
        <div class="row col-12">
          <div v-if="$attrs.title" class="col-12 text-center text-h5 q-pb-md">{{ $attrs.title }}</div>
          ...
          >
            ...
            <template v-if="gridCardStyle === 'horizontal'">
              <q-card-section class="relative-position">
                ...
                />
                <div v-if="!toggleSelectionMode" class="ellipsis-2-lines">{{ props.cols[0].value }}</div>
              </q-card-section>
              <q-separator/>
    ...
    <q-page-scroller class="z-max" position="bottom-right" :scroll-offset="400" :offset="[16, 16]">
      <q-btn class="z-top" fab icon="keyboard_arrow_up" color="accent"/>
    </q-page-scroller>
...
export default {
  ...
  methods: {
    ...
    toggleFullscreen(props) {
      ...
      this.inFullscreen = !props.inFullscreen
